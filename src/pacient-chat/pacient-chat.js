            ...
            <div className='half-side'>
                <div className='chat'>
                    ...
                    <div className='chat-person'>
                        ...
                        <div className="chat-text"><p>Hello! I checked you surgery data and for two weeks you can eat
                            anything but diary and alchool.</p></div>
                    </div>
                ...
                <div className='chat-info'>
                    <h3 className='text'>STOP WAITING FOR A CALL BACK! WRITE A MESSAGE TO DR. MEREDITH AND YOU WILL GET
                        A RESPONSE AS SOON AS POSSIBLE.</h3>
                    <div className='doctor-info'>
                        <div style={{display: "flex", flexDirection: "row"}}>
                            <img src={image} alt="doctorImg" className="doctorImg"
                                 style={{marginTop: "30px", width: "160px", height: "160px"}}/>
                            <div>
                                <h4 style={{
                                    marginLeft: "10px",
                                    marginTop: "30px",
