    ...
    const togglePacient2Open = () => {
        ...
        return (
            ...
            <div className="devices-map">
                ...
                <div className="icon" onClick={() => togglePacient2Open()} style={{left: "200px", top: "360px", color: "#990D0D"}}>!</div>
                {isPacient2Open &&
                <div className="icon-open" style={{left: "230px", top: "160px"}}>
                 ...
                 <div>
                 <img src={client2} style={{width: "70px", marginLeft: "10px", marginTop: "10px", borderRadius: "108px"}}></img>
                ...
                <div className="icon" onClick={() => togglePacient1Open()} style={{left: "1103px", top: "300px"}}>IV</div>
                {isPacient1Open &&
                <div className="icon-open" style={{left: "685px", top: "340px"}}>
                 ...
                 <div>
                 <img src={client} style={{width: "70px", marginLeft: "10px", marginTop: "10px", borderRadius: "108px"}}></img>
