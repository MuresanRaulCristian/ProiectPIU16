        ...
        <div className="navigation-bar" expand="md">
            ...
            <Nav className="nav-button" navbar>
                <NavLink style={{textDecoration: "none", padding: "50px 25px 30px 25px", color: "white"}}
                         href="/pacient">HOME</NavLink>
                <NavLink style={{textDecoration: "none", padding: "50px 25px 30px 25px", color: "white"}}
                         href="/doctors">DOCTORS</NavLink>
                <NavLink style={{textDecoration: "none", padding: "50px 25px 30px 25px", color: "white"}}
                         onMouseOver={() => setMyDataDropdownOpen(false)} href="/emergency">EMERGENCY</NavLink>
                <NavLink style={{textDecoration: "none", padding: "50px 25px 30px 25px", color: "white"}}
                         onMouseOver={() => setMyDataDropdownOpen(true)} href="/data">MY DATA</NavLink>
                {isMyDataDropdownOpen &&
                    <div className="dropdown-data" onMouseLeave={() => setMyDataDropdownOpen(false)}>
                        ...
                        <a style={{textDecoration: "none"}} href="/pacient/form">HOW I FEEL</a>
                    </div>}
                <NavLink style={{textDecoration: "none", padding: "50px 25px 30px 25px", color: "white"}}
                         onMouseOver={() => setMyDataDropdownOpen(false)} href="/pharmacy">PHARMACY</NavLink>
            </Nav>
        </div>
    )
}
